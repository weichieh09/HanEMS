...
export default class BlackList extends mixins(JhiDataUtils) {
  ...
  public retrieveAllBlackLists(): void {
  ...
  public prepareRemove(instance: IBlackList): void {
  ...
  public removeBlackList(): void {
    this.blackListService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('hanEmsApp.blackList.deleted', { param: this.removeId });
