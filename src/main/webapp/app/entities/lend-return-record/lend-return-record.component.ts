...
export default class LendReturnRecord extends mixins(JhiDataUtils) {
  ...
  public mounted(): void {
    this.retrieveAllLendReturnRecords();
  }
  ...
  public retrieveAllLendReturnRecords(): void {
  ...
  public prepareRemove(instance: ILendReturnRecord): void {
  ...
  public removeLendReturnRecord(): void {
    this.lendReturnRecordService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('hanEmsApp.lendReturnRecord.deleted', { param: this.removeId });
